%% FUNCTION SCEN  
function [scen_lim,scen_red] = SCEN(n_scen_gen,MU,coef_fit_var,norm_var,forecast,samples_scenario,cdf_stable,pdf_stable,pdf_stable_ee,w_int,w_ee,error_vec,n_scen_select,actual_realization,ff_mode,day)   
    tic
    %% Scenario generation
    ...
    x = mean(forecast_pb);
    eps_init = xlsread('simulation_parameters.xlsx','Sheet1','C22'); % initial value for covariance matrix
...
%     scen_prob = scen_prob./tot_prob;
    ...
    cut_off_prob = xlsread('simulation_parameters.xlsx','Sheet1','C27');
    n_scen_gen_retain = xlsread('simulation_parameters.xlsx','Sheet1','C26');
